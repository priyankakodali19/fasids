            ...
            using (FASIDSEntities db = new FASIDSEntities())
            {
                ...
                foreach (Product_list u in Product_list)
                {
                    ...
                    if (u.IsBroadcast == true && u.IsMound == true)
                    {
                        ...
                        PI.B_ProductMeasurementUnit = u.Broadcast_MeasurementUnit.ToUpper();
                        PI.M_ProductMinUseRate = Convert.ToDouble(u.Mound_MinUseRate);
                        PI.M_ProductMaxUseRate = Convert.ToDouble(u.Mound_MaxUseRate);
                        PI.M_ProductMeasurementUnit = u.Mound_MeasurementUnit.ToUpper();
                        string x = "Broadcast: " + u.Broadcast_MinUseRate + " - " + u.Broadcast_MaxUseRate + " " + u.Broadcast_MeasurementUnit.ToUpper();
                        string y = "Mound: " + u.Mound_MinUseRate + " - " + u.Mound_MaxUseRate + " " + u.Mound_MeasurementUnit.ToUpper();
                    ...
                    else
                    {
                        if (u.IsBroadcast == true)
                        {
                            ...
                            PI.B_ProductMaxUseRate = Convert.ToDouble(u.Broadcast_MaxUseRate);
                            PI.B_ProductMeasurementUnit = u.Broadcast_MeasurementUnit.ToUpper();
                            string x = u.Broadcast_MinUseRate + " - " + u.Broadcast_MaxUseRate + u.Broadcast_MeasurementUnit.ToUpper();
                            PI.ProductMeasurementUnit2.Add(x);
                        }
                        else 
                        {
                            ...
                            string y =  u.Mound_MinUseRate + " - " + u.Mound_MaxUseRate + u.Mound_MeasurementUnit.ToUpper();
                            PI.ProductMeasurementUnit2.Add(y);

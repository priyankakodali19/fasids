...
namespace WebApplication3.Models.EntityManager
{
    public class InteractiveLandscapeManager
    {
        public string AddUserPolygon(String polygonJson)
        {
            ...
            using (FASIDSEntities5 db = new FASIDSEntities5())
            {
                ...
                PG.Bounds_NE_Lng = dynObj.properties.bounds.ne.lat;
                PG.Bounds_NE_Lat = dynObj.properties.bounds.ne.lng;
        ...
        public DisplayUserPolygon GetUserDataView(string polygonid)
        {
            ...
            using (FASIDSEntities5 db = new FASIDSEntities5())
            {
                ...
                DUP.Bounds_NE_Lng = polygon.FirstOrDefault().Bounds_NE_Lng;
                DUP.Bounds_NE_Lat = polygon.FirstOrDefault().Bounds_NE_Lat;
                DUP.Bounds_SW_Lat = polygon.FirstOrDefault().Bounds_SW_Lat;
                DUP.Bounds_SW_Lng = polygon.FirstOrDefault().Bounds_SW_Lat;
                ...
                DUP.TotalArea = polygon.FirstOrDefault().TotalArea;
                ...
                var result = DUP.Coordinates.AsText();
                var asv = result;
